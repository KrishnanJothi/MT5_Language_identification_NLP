...
- This entire project was run in Google Colaboratory. To directly open the .ipynb file in Google colab, click [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/KrishnanJothi/MT5_Language_identification_NLP/blob/main/MT5_fine-tuning.ipynb).<br /> Before running the code in Google Colab, change the runtime type to GPU. To do that, click the “Runtime” dropdown menu, then select "Change runtime type". Now select GPU in the “Hardware accelerator” dropdown menu.
